        ...
        if lhs.n > tiny and rhs.n > tiny: 
          ...
          if maybe < least : 
            ...
            if gain >= (log2(n0-1) + delta)/n0: 
              cut,least = j+1,maybe #### Here is bug in Dr. Menzies' code. Originally, it was cut = j
      last= now
    return cut,least # cut: index of ordered decisions, least: the ent
  #--------------------------------------------
...
def _ediv():
  ...
  def go(lst):
    ...
    for d in  ediv(lst,tiny=2):
      rprint(d); nl()
  X,Y="X","Y"
  l=[(1,X),(2,X),(3,X),(6,X),(11,Y),(12,Y),(13,Y),(14,Y)]
  go(l)
  # l[0] = (1,Y)
  # go(l)
  # go(l*2)
  # go([(1,X),(2,X),(3,X),(4,X),(11,X),(12,X),(13,Y),(14,Y)])
